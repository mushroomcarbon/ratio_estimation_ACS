...
The estimates (via the ratio estimation method) and actual number of respondents is as follows:
...
# Display the table
kable(data, caption = "Estimated Total Respondents (via ratio estimation method) vs Actual Total Respondents by State")
```
